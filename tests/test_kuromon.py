...
def test_to_table_with_dataclass_without_index(
    dataclass_data: List[Any], table_without_index: str
):
    assert to_table(dataclass_data, index=False) == table_without_index


def test_to_table_with_pydantic_without_index(
    pydantic_data: List[Any], table_without_index: str
):
    assert to_table(pydantic_data, index=False) == table_without_index
